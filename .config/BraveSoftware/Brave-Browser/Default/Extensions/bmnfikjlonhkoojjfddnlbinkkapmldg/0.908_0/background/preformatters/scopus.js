var BINPreformatter = ( function () {
    ...
    //fix publisher and language
    metaData["citation_publisher"] = metaData["citation_publisher"].replace(/^[\s]*publisher[\s]*/i,"");
    metaData["citation_language"] = metaData["citation_language"].replace(/^.*language[\s]*/i,"");
		...
		if (metaData["citation_type"].search(/book/i) != -1) {
			...
			//add collection title if chapter found
			if (metaData["citation_type"].search(/chapter/i) == -1) {
        metaData["citation_collection_title"] = "";
      } else {
        metaData["citation_collection_title"] = metaData["citation_journal_title"];
      }
      ...
      metaData["citation_journal_title"] = "";
		...
		//fix issn/isbn
		metaData["citation_isbn"] = metaData["citation_isbn"].replace(/\,.*$/gi,"");
