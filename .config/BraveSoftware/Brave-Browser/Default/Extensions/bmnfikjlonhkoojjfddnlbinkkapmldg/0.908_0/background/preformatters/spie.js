...
// 		if (metaData["citation_type"].search(/isbn/i) == -1) metaData["citation_download"] = metaData["citation_download"].replace(/(?:A1|AU)[\t\ ]+[\-]+[\t\ ]+/g,"BIT - ").trim();
    ...
    //fix collection_title
    metaData["citation_collection_title"] = metaData["citation_collection_title"].replace(/\;[\s]*$/gi,"");
    ...
    //fix publisher
    if (metaData["citation_publisher"] == "") metaData["citation_publisher"] = "SPIE";
