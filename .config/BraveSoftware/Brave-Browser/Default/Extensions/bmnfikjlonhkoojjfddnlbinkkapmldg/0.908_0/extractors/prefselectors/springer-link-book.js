var BINPrefselector = ( function () {
	...
	function formatCitationLink(metaData, link) {
		...
		return ("https://" + link.replace(/^[\s]*https[\s\:\/]*/i,""));
	}
	...
	var prefselectorMsg = {
		...
		citation_date: [ ['ul.c-bibliographic-information__list li.c-bibliographic-information__list-item time','datetime'], ['div.article-dates time','datetime'], ['input[name="year"]','value'] , ['dd#abstract-about-book-chapter-copyright-year','innerText'] , ['span#copyright-info','innerText'] ],
